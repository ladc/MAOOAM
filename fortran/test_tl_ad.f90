...
PROGRAM test_tl_ad
  ...
  USE tl_ad_integrator, only: init_tl_ad_integrator,tl_step, init_tl_ad_integrator,ad_step
  IMPLICIT NONE
  ...
  CALL init_tl_ad_integrator  ! Initialize the TL integrator
  CALL init_tl_ad_integrator  ! Initialize the AD integrator
