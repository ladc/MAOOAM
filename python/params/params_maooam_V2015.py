...
h = 164.8 # depth of the water layer of the ocean
d = 1.1e-7  # the coupling parameter (should be divided by f0 to be adim)
...
# Other temperature-related parameters/constants
sc = 1.  # Ratio of surface to atmosphere temperature
lambdaa = 15.06  # Sensible+turbulent heat exchange between oc and atm
rr = 287.e0  # Gas constant of dry air
sb = 5.6e-8  # Stefan-Boltzmann constant
