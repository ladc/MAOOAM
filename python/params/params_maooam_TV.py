"""
	...
	.. note :: The python code is available here : `params_maooam.py <../_modules/params_maooam.html>`_ and on `Git <https://github.com/nansencenter/DAPPER/blob/max1/mods/MAOOAM/params_maooam.py>`_.
...
t_run = 100#3244.44  #  length of trajectory on the attractor (e.g. 5.e8)
...
d     = 9e-8  # 1.1 10-7 GMDs the coupling parameter (should be divided by f0 in order to be adimensional)
...
lambdaa =15.06   #  15.06 GMD Sensible + turbulent heat exchange between ocean and atmosphere
